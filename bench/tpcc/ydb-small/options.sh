# https://github.com/zinal/ydb-snippets/tree/main/admin/vms
...
#yc_platform=standard-v4a
# Выбранный образ операционной системы виртуалок
#yc_vm_image="image-folder-id=standard-images,image-name=astralinux-alse-v20250527"
yc_vm_image="image-folder-id=standard-images,image-family=ubuntu-2404-lts"
...
#yc_vm_image="image-folder-id=standard-images,image-name=redsoft-red-os-standard-server-8-0-v20250327"
...
#yc_data_disk_type=network-ssd-io-m3
yc_boot_disk_size=50G
