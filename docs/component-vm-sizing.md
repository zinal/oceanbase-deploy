...
| **obproxy-ce** | Да, 1–N | Низкая, stateless | 2 vCPU, 4 GB RAM | Прокси не хранит данные; дешёвые ВМ, отдельное масштабирование. `proxy_mem_limited` по умолчанию **2G** (не RAM хоста) — [docs/obproxy-memory.md](obproxy-memory.md) |
